	...
	<div id="layout">
		...
		<article id="mainArticle">
			...
			<table border="0" width="1024px" align="center" cellpadding="0"
				...
				<c:forEach var="result" items="${myBidList}" varStatus="status">
				<tr class="auctionList">
					...
					<td style="text-align:center;">
						...
						<c:if test="${result.boolean_isBid == true}">
							<button class="button red big" type="button" onClick="location.href = './insertBuyForm.do?article_id=${result.article_id}';">구매하기</button>
						</c:if>
					</td>					
				</tr>
				</c:forEach>
